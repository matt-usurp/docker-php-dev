...
* `7.1` (currently targeting `7.1.28`)
* `7.2` (currently targeting `7.2.17`)
* `7.3` (currently targeting `7.3.4`)
...
For example `musurp/php:7.1.28-cli` and `musurp/php-dev:7.2.17-fpm`.
...
```sh
$ docker run musurp/php:7.3.4-cli-supervisor
```
...
```sh
$ docker run musurp/php:7.3.4-cli-supervisor --configuration /srv/path/conf.conf
```
...
services:
  worker:
    image: musurp/php:7.3.4-cli-supervisor
